...
function Export-InactiveAzureUsers {
    ...
    foreach($azaduser in $azadusers){
        ...
        $getuserlogons = $signins | Where-Object {$_.userid -eq $azureaduser} | Sort-Object createddatetime -Descending | Select-Object -First 1 
    ...
    elseif($users -eq $null -and $filepath -eq $null){
